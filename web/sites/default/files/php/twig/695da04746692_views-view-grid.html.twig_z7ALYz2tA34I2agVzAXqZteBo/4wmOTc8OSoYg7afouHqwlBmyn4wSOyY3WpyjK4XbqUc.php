...
class __TwigTemplate_2fd421d9e6948b938e3c349f9537dbaf extends Template
{
  ...
  ";
        ...
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["options"] ?? null), "alignment", [], "any", false, false, true, 55) == "horizontal")) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
                // line 57
                yield "      <div";
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["row"], "attributes", [], "any", false, false, true, 57), "addClass", [($context["row_classes"] ?? null), (((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["options"] ?? null), "row_class_default", [], "any", false, false, true, 57)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (("row-" . CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, true, 57))) : (""))], "method", false, false, true, 57), "html", null, true);
                yield ">
        ";
                // line 58
                $context['_parent'] = $context;
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["column"]) {
                    // line 59
                    yield "          <div";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["column"], "attributes", [], "any", false, false, true, 59), "addClass", [($context["col_classes"] ?? null), (((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["options"] ?? null), "col_class_default", [], "any", false, false, true, 59)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (("col-" . CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, true, 59))) : (""))], "method", false, false, true, 59), "html", null, true);
                    yield ">";
                    // line 60
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["column"]) {
                // line 67
                yield "      <div";
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["column"], "attributes", [], "any", false, false, true, 67), "addClass", [($context["col_classes"] ?? null), (((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["options"] ?? null), "col_class_default", [], "any", false, false, true, 67)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (("col-" . CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, true, 67))) : (""))], "method", false, false, true, 67), "html", null, true);
                yield ">
        ";
                // line 68
                $context['_parent'] = $context;
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
                    // line 69
                    yield "          <div";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["row"], "attributes", [], "any", false, false, true, 69), "addClass", [($context["row_classes"] ?? null), (((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["options"] ?? null), "row_class_default", [], "any", false, false, true, 69)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (("row-" . CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, true, 69))) : (""))], "method", false, false, true, 69), "html", null, true);
                    yield ">";
                    // line 70
